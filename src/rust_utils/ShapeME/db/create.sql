...
INSERT INTO jobs (id, name, args, version, path, fa_path, score_path, uid) VALUES ("uGNqFAaVyP0a", "testname", "args", "0.1.0", "don't ", "worry", "boutit", 1);
INSERT INTO jobs (id, name, args, version, path, fa_path, score_path, uid) VALUES ("uGNqFAaVyP0a", "shouldn't exist (non-unique id)", "args", "0.1.0", "no", "path", "here", 1);
