...
####    ##############################################################
    ...
    def merge_with_motifs(self, other, max_count, fimo_fname, rec_db, pval_thresh, nosort=False):
    ...
    def new_with_motifs(self, other, max_count, fimo_fname, rec_db, pval_thresh, nosort=False):
